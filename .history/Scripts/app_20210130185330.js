...
(function(){
    ...
    function displayProjects()
    {
        ...
        let projectsDescriptionElement = document.getElementById("p1Description");
        p1TextElement.textContent = p1Text;
        p1DescriptionElement.textContent = p1Description;

        projectsTextElement = document.getElementById("p2");
        projectsDescriptionElement = document.getElementById("p2Description");
        p1TextElement.textContent = p2Text;
        p1DescriptionElement.textContent = p2Description;

        projectsTextElement = document.getElementById("p3");
        projectsDescriptionElement = document.getElementById("p3Description");
        p1TextElement.textContent = p3Text;

...
(function(){
    ...
    function displayAbout()
    {
        ...
        let andreText = "I'm a 2nd year \r student at Durham College in the Computer Programming and Analysis program.";

        //Projects 1
        let headerElement = document.getElementById("aboutAHeader");
        let descriptionElement = document.getElementById("aboutAText").innerHTML = "Hello \
        Dolly!";
        headerElement.textContent = andreHeader;
        // descriptionElement.textContent = `Hello \
        // Dolly!`;

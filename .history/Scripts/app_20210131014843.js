...
(function(){
    ...
    function displayAbout()
    {
        ...
        descriptionElement = document.getElementById("aboutAHeader").textContent = "Michai Header";
        descriptionElement = document.getElementById("aboutAText").textContent = "Michai Description";

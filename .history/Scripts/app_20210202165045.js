...
(function(){
    ...
    function displayProjects()
    {
        ...
        //Projects 1
        let projectsTextElement = document.getElementById("projectsTitle").textContent = p1Text;
        let p1DescriptionElement = document.getElementById("projectsText").textContent = p1Description;

        //Projects 2
        projectsTextElement = document.getElementById("projectsTitle").textContent = p2Text;
        p1DescriptionElement = document.getElementById("projectsText").textContent = p2Description;
        //Projects 3
        projectsTextElement = document.getElementById("projectsTitle").textContent = p3Text;
        p1DescriptionElement = document.getElementById("projectsText").textContent = p3Description;

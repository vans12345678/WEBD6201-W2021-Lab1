...
(function(){
    ...
    function displayAbout()
    {
        ...
        let andreTextElement = document.getElementById("aboutAHeader");
        let andreDescriptionElement = document.getElementById("aboutAText");
        
        andreTextElement.textContent = andreHeader;
        andreDescriptionElement.textContent = andreText;

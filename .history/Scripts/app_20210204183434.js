...
(function(){
    ...
    function DisplayNav()
    {
        ...
        hrListItem.setAttribute("class", "nav-link")
        let navbar = document.getElementById("ulNav").appendChild(hrListItem);
        hrListItem.innerHTML = `<a class="nav-link" aria-current="page" href="human-resources.html"><i id ="navHumanResources" class ="fas fa-project-diagram fa-lg">Human Resrouces</i></a>`;

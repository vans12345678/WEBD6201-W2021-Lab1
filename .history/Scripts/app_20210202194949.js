...
(function(){
    ...
    function DisplayNav()
    {
        ...
        if(document.title = "Human Resources")
        {
            ...
            <a  class="nav-link fas fa-fingerprint fa-lg active" aria-current="page" href="human-resources.html">Human Resurces</a>
            `;
        }
        navTextElement = document.getElementById("navHumanResources").innerHTML = `
            <a  class="nav-link fas fa-fingerprint fa-lg" aria-current="page" href="human-resources.html">Human Resrces</a>
            `;

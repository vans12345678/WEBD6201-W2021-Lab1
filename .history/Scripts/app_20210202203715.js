...
(function(){
    ...
    function DisplayNav()
    {
        ...
        navTextElement = document.getElementById("navAbout").innerHTML += `</li>
        </li>
            <a  class="nav-link fas fa-fingerprint" aria-current="page" href="human-resources.html">Human Resources</a>
            `;
